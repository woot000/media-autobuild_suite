...
SOURCE_REPO_GEXIV2=https://github.com/GNOME/gexiv2.git#commit=4cdd21184a1de9418ea3c413c8b6209bc5ce39be
...
SOURCE_REPO_GTK=https://github.com/GNOME/gtk.git#branch=gtk-3-24
...
SOURCE_REPO_PYGOBJECT=https://github.com/GNOME/pygobject.git#tag=3.54.5
