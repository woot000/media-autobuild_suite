...
SOURCE_REPO_APPSTREAM=https://github.com/ximion/appstream.git#commit=363bd386c79d43b2c9d3337d0067fb41cd12cc1d
...
SOURCE_REPO_MYPAINT_BRUSHES=https://github.com/mypaint/mypaint-brushes.git
...
SOURCE_REPO_OPENJPH=https://github.com/aous72/OpenJPH.git
...
SOURCE_REPO_PYGOBJECT=https://gitlab.gnome.org/GNOME/pygobject.git#tag=3.54.0
